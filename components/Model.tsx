...
import {useGLTF, Float, useCubeTexture} from "@react-three/drei";
import {MotionValue, useTransform} from 'framer-motion';
import { motion } from 'framer-motion-3d';
import {MeshBasicMaterial, MeshPhysicalMaterial, TextureLoader} from "three";

interface MeshProps {
    node: any; // Specify the type for node here
    multiplier: number;
    mouse: {
        x: MotionValue
        y: MotionValue
...
export default function Model({mouse}: {mouse: {x: MotionValue<any>, y: MotionValue<any>}}) {
